...
def send_email(subject, body, to_email, attachment_path):
    ...
    msg['Subject'] = subject
    msg['From'] = 'nurlanuuulubeksultan@gmail.com'  # Replace with your email address
    msg['To'] = to_email
    ...
    server.starttls()
    server.login('nurlanuuulubeksultan@gmail.com', 'afhqrpaytpedcfzw')  # Replace with your email address and password
